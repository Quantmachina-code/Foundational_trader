"""Run TabICL on prebuilt panel parquet data."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run TabICL using prepared parquet panel.")
    ...
    parser.add_argument("--output", default="outputs/tabicl_predictions.csv", help="Prediction output csv path.")
    ...
    if not HAS_TABICL:
        raise RuntimeError("TabICL is not available. Install tabicl and place tabicl*.ckpt in repo root.")
